...
const Review = ({ review }) => {
    const { title, description, name, image, rating } = review
    return (
        <div className='mb-10'>
            <section class="text-white body-font mx-10 border-2 border-white">
                <div class="container w-full">
                    <div class="p-4">
                        <div class="h-full bg-black p-8 rounded">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="block w-5 h-5 text-gray-400 mt-4" viewBox="0 0 975.036 975.036">
                            ...
                            <div class="inline-flex items-center">
                                <img alt="testimonial" src={image} class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
