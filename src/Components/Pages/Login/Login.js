    ...
    const handleLogIn = (event) => {
        ...
        logIn(email, password)
            .then(res => {
                ...
                fetch('https://paparazzo-photography-server.vercel.app/jwt', {
                    method: 'POST',
                    headers: {
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <form onSubmit={handleLogIn}>
                            <div>
                                ...
                                <input id="email" aria-labelledby="email" type="email" name='email' className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="john@gmail.com " required />
                            </div>
